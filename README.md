...
Volume & Net Revenue (Net Revenue, Variable/Fixed Cost of Delivery).

Dead-Net & Cost of Goods Sold (COGS) (Freight, Customs, Insurance).

Sales Gross Profit (Marketing, Operating Income, Coolers).

Sales EBITDA (Overall contribution margin and operational profitability).

Multi-Scenario Comparison (ACT vs. PLAN vs. LY): Instantly track variances like TY vs LY (This Year vs Last Year) and ACT vs PLAN (Actual vs Budget) to identify underperforming sectors or cost overruns.

Granular FMCG Slicers: Segment entire financial statements instantly by:

Brand Tier & Portfolio: Filter by Branded products vs. Private Label (PLB).

Packaging & Sizes: Analyze specific contributions from various pack types (e.g., 250ML, 330ML, 500ML, Multipacks 6P/8P, 1500ML).

Temporal & Geographical Views: Toggle between full-year views (2024, 2025, 2026) and specific months or countries (e.g., Greece/GR).
